...
def scraper(parid,pFile,sFile,tFile):    
...
for indx, i in enumerate(range(16030010967,16030011999)):
    rP1, rOH, rTR = scraper(i,'propertyInfo_1603x.csv','saleTransactions_1603x.csv','taxReceivable_1603x.csv')

# for indx, i in enumerate(range(16030000100,16030213501)):
#     rP1, rOH, rTR = scraper(i,'propertyInfo_1603.csv','saleTransactions_1603.csv','taxReceivable_1603.csv')
